...
class Maze:
    ...
    #return True if at the end cell or lead to the end cell. Otherwise, False 
    def _solve_r(self, i, j):
        ...
        #if at the end, done, return True
        if i == self._num_cols - 1 and j == self._num_rows - 1:
            return True

        # go left if no wall and it hasn't visited
        ...
        # go right if no wall and it hasn't visited
        ...
        # go up if no wall and it hasn't visited
        ...
        # go down if no wall and it hasn't visited
        ...
        # Once went to worng way. Back to previous cell
        return False
    
    # create the moves for the solution by using a depth first search
    def solve(self):
